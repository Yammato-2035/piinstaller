> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/recovery/RECOVERY_MINIMAL_EXECUTE_PREP_EN.md`). Bitte bei Release manuell gegenlesen.

# Recovery Minimal Execute Prep (EN)

## Goal
Prepare session and execute contracts for a future recovery execution phase.
Non step is executed in this phase.
