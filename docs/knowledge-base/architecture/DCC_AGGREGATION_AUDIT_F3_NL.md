> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/knowledge-base/architecture/DCC_AGGREGATION_AUDIT_F3_EN.md`). Bitte bei Release manuell gegenlesen.
...
5. **Frontend** lacks central `dccStatusViewModel` — duplicate risk with Terugend mappings.

## Volgende safe migration
