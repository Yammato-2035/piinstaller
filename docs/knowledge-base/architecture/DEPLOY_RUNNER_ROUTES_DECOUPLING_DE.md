> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/knowledge-base/architecture/DEPLOY_RUNNER_ROUTES_DECOUPLING_EN.md`). Bitte bei Release manuell gegenlesen.
...
`routes.py`: 4821 lines, 218 routes, 103 imports. Ziel <500 / 0 imports.
