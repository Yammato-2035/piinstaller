> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/knowledge-base/architecture/APP_ROUTER_SLICE_CANDIDATE_AUDIT_E7_EN.md`). Bitte bei Release manuell gegenlesen.
...
**E.8** — extract the 3 DCC lecture seule GETs **or** facade phase for system/DCC status (plan in parallel; do Nont mix).
