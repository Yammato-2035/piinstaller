> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/knowledge-base/architecture/DCC_STATUS_FACADE_EN.md`). Bitte bei Release manuell gegenlesen.

# DCC Stand Fassade — Phase F.1 (EN)

**HEAD:** `03fbc09` · **Stand:** CANONICAL_MODULE (FACADE)
...
- `DccStandSection`, `DccStandFassadeResult`, `DccStandFassadeWarning`
