> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/knowledge-base/architecture/DEPLOY_RUNNER_REGISTRY_EN.md`). Bitte bei Release manuell gegenlesen.
