> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/knowledge-base/architecture/DEPLOY_RUNNER_ROUTES_DECOUPLING_EN.md`). Bitte bei Release manuell gegenlesen.
...
Suivant step: **D.7** evidence plan-only.

See `Déploiement_ROUTES_THIN_ORCHESTRATOR_EN.md`.
