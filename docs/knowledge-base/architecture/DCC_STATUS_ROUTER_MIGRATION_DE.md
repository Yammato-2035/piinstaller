> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/knowledge-base/architecture/DCC_STATUS_ROUTER_MIGRATION_EN.md`). Bitte bei Release manuell gegenlesen.

# DCC Stand Router Migration — Phase F.2 (EN)

**HEAD:** `3c98105` · **Stand:** done
