> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/knowledge-base/architecture/DCC_STATUS_ROUTER_MIGRATION_EN.md`). Bitte bei Release manuell gegenlesen.
