> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/knowledge-base/architecture/CORE_FACADES_EN.md`). Bitte bei Release manuell gegenlesen.

# Core Fassades — Storage, Mount, Safety (Phase A.1)

**Stand:** Fassade Freeze A.1 + safety A.2–A.4 + storage B.1  
...
Types: `BlockDeviceInfo`, `MountInfo`, `StorageZielClassification`, `ReadonlyMountPlan`, `SafetyContext`, `SafetyDecision`.
...
- Regeln: `docs/architecture/CORE_FACADE_RULES.md` (DE) / `CORE_FACADE_RULES_EN.md`
