> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/knowledge-base/cloud/PUBLIC_PRIVATE_BOUNDARY_DE.md`). Bitte bei Release manuell gegenlesen.
...
Das **öffentliche Repository** enthält Setuphelfer **Core**, **Rescue stick**, **Deploy-Runner**, **Facades** und **öffentliche Contracts**:
...
| Diagnostikserver (internal) | Matcher, zentrale Analyse |
...
- `telemetry.internalal.setuphelfer.example`
- `cloud.private.setuphelfer.example`
- `operator.internalal.setuphelfer.example`
