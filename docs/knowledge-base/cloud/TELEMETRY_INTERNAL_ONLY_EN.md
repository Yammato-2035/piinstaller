> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/knowledge-base/cloud/TELEMETRY_INTERNAL_ONLY_DE.md`). Bitte bei Release manuell gegenlesen.

# Telemetrie — Nur internal (Server) (DE)

**Stand:** 2026-06-16  
**Kurzfassung** — siehe [`docs/architecture/TELEMETRY_internalAL_ONLY_CONCEPT.md`](../../architecture/TELEMETRY_internalAL_ONLY_CONCEPT.md)
...
[`docs/private-handoff/TELEMETRY_internalAL_SERVER_HANDOFF.md`](../../private-handoff/TELEMETRY_internalAL_SERVER_HANDOFF.md)
