...
- **2026-06-03 (QEMU 212528 ingest):** Operator deploy+ISO rebuild (`bae2be32…`); Run `212528` — ModuleNotFound/Invalid Host **weg**; **`agent_send_failed`**, `guest_report_missing`; DCC unter release erwartbar off. Evidence: `QEMU_212528_INGEST_RESULT.md`. USB gesperrt.
