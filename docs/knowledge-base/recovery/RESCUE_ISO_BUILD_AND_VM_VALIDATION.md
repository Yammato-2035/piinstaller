...
- **2026-06-02 (controlled precheck, no build):** Release/Fleet/DCC/Ingest ok; Toolchain ok; **Build-Tree root-owned Reste** vom Prior-Build (Jun 1) — Cleanup-Handoff vor `--operator-confirm-build`. Evidence: `CONTROLLED_RESCUE_ISO_BUILD_PRECHECK_RESULT.md`.
