...
- **2026-06-03 (autopilot wants fix):** Static wants symlink in prepare (developer-qemu only); squashfs validator extended; ISO rebuild required. No build/QEMU in fix run.
