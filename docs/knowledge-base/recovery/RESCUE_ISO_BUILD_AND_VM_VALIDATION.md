...
- **2026-06-02 (controlled build + ingest):** Operator-Build LB_EXIT=0; ISO SHA `505989f7…` (511705088 B); Squashfs-Validator Exit 0; **ready_for_qemu_guest_agent_smoke** — kein Boot/USB in diesem Lauf. Evidence: `CONTROLLED_RESCUE_ISO_BUILD_RESULT.md`.
