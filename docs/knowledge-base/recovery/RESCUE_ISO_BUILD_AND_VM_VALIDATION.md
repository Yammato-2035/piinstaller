...
- **2026-06-02 (build-tree cleanup):** Operator clean **ok**; stale hybrid ISO/chroot/cache entfernt; Validate Exit 14 (`PYTHONPATH` override in dev-agent service). Evidence: `RESCUE_ISO_BUILD_TREE_CLEANUP_RESULT.md`.
