> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/runbooks/MSI_F2_IMAGE_BACKUP_EXECUTION_PROMPT_DRAFT_DE.md`). Bitte bei Release manuell gegenlesen.
...
- Ziel: nur externales Medium aus F.1 (`/dev/sda` — Operator bestätigt)
