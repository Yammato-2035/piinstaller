> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/runbooks/deploy-runner/RUNTIME_RUNBOOK_MASTER_EN.md`). Bitte bei Release manuell gegenlesen.

# Runtime Runbook Master (EN)

## Purpose
This document bundles all seven manual runtime runbooks. Nee automatic execution.

## Scope
Runner runtime execution bundle (manual).

## Forbidden Actions
- Nee real Apparaat write
- Nee sudo/root runner
- Nee real Deploy
- Nee automatic execution
...
5. `RUNBOOK_Apparaat_REENUMERATION`
6. `RUNBOOK_HOTPLUG_UNMOUNT_RACE`
7. `RUNBOOK_ROLLTerug_RUNTIME`
