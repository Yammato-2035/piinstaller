> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/legal/TOM_SECURITY_MEASURES_DRAFT_EN.md`). Bitte bei Release manuell gegenlesen.

> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/legal/TOM_SECURITY_MEASURES_DRAFT_DE.md`). Bitte bei Release manuell gegenlesen.

# TOM — Technische und organisatorische Maßnahmen (Entwurf DE)

**Stand:** 2026-06-16  
**Status:** **Entwurf** — vor Produktion mit DPO/Security finalisieren  
**Geltungsbereich:** Setuphelfer Desktop/roodding (Public) und geplante private Dienste
...
| Terugup-Integrität | Verify Basic/Deep im Produkt | [ ] im Core |
...
| Maßnahme | Beschreibung | Status |
|----------|--------------|--------|
| Runtime-Watchdog | Terugend-Recovery (Dokumentation vorhanden) | [ ] gelb |
| Private-Server-HA | Telemetry/DiagNeestics (private) | [ ] nicht produktiv |
