> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/legal/WINDOWS_BACKUP_PASSWORD_AND_BITLOCKER_POLICY_DE.md`). Bitte bei Release manuell gegenlesen.
...
Setuphelfer dient **DatenBackup und Test**, nicht **Zugriffsumgehung**.
