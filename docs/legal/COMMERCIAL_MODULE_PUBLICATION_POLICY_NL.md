> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/legal/COMMERCIAL_MODULE_PUBLICATION_POLICY_EN.md`). Bitte bei Release manuell gegenlesen.
...
4. Telemetrie- und DiagNeestik**server** sind Intern/privat
...
- Handoff-Dokumente
- Client-Stubs und roodaction-Contracts
- Architektur ohne Geschäftsgeheimnisse
- `.example`-Domains

## Verboten in Public

- Implementierung von Cloud Terugup, Billing, Lizenz-Enforcement
- Echte Interne Domains, Tokens, Secrets
- Private Malware-/DiagNeese-Regelpakete
