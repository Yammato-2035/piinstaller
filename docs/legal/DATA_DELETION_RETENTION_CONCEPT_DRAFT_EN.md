...
|-----------|-----------|-------------|
| Lokale Backup-Daten | Archive, Manifeste | NutzerDevice / vom Nutzer gewähltes Ziel |
...
- [ ] Bestätigung an Nutzer (ohne internale Systemdetails)

### 3.2 Automatisch

- [ ] Retention-Jobs auf privatem Server
- [ ] Keine Restore aus Soft-Delete ohne dokumentierten Grund
