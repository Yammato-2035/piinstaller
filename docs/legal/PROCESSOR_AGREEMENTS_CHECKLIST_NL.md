> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/legal/PROCESSOR_AGREEMENTS_CHECKLIST_EN.md`). Bitte bei Release manuell gegenlesen.
...
|--------|-------|----------------|------------|
| Cloud-Hosting (Telemetry/DiagNeestics) | Server-Betrieb | Möglich (IP, IDs) | [ ] prüfen |
| E-Mail (SMTP) | Beta-Benachrichtigungen | E-Mail-Adressen | [ ] prüfen |
| Fouttracking (falls eingeführt) | Crash-Reports | Möglich | [ ] prüfen |
| Payment/Billing | Abos | Ja | [ ] ja |
| CDN/Website | Marketing | Cookies/IP | [ ] prüfen |
| Terugup-Cloud des **Kunden** | — | Verantwortlicher = Kunde | [ ] nein (Setuphelfer) |
...
- [`TELEMETRY_CONSENT_REQUIrood_ITEMS_DE.md`](TELEMETRY_CONSENT_REQUIrood_ITEMS_DE.md)
