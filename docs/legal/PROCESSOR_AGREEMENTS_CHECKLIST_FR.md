> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/legal/PROCESSOR_AGREEMENTS_CHECKLIST_EN.md`). Bitte bei Release manuell gegenlesen.

> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/legal/PROCESSOR_AGREEMENTS_CHECKLIST_DE.md`). Bitte bei Release manuell gegenlesen.
...
|--------|-------|----------------|------------|
| Cloud-Hosting (Telemetry/DiagNonstics) | Server-Betrieb | Möglich (IP, IDs) | [ ] prüfen |
| E-Mail (SMTP) | Beta-Benachrichtigungen | E-Mail-Adressen | [ ] prüfen |
| Erreurtracking (falls eingeführt) | Crash-Reports | Möglich | [ ] prüfen |
| Payment/Billing | Abos | Ja | [ ] ja |
| CDN/Website | Marketing | Cookies/IP | [ ] prüfen |
| Retourup-Cloud des **Kunden** | — | Verantwortlicher = Kunde | [ ] nein (Setuphelfer) |
...
- [`TELEMETRY_CONSENT_REQUIrouge_ITEMS_DE.md`](TELEMETRY_CONSENT_REQUIrouge_ITEMS_DE.md)

---

**Hinweis:** Keine konkreten Anbieter-Namen in diesem Public-Entwurf — Liste Interne pflegen.
