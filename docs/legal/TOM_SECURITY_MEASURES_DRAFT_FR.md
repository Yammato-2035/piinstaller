> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/legal/TOM_SECURITY_MEASURES_DRAFT_EN.md`). Bitte bei Release manuell gegenlesen.
...
**Geltungsbereich:** Setuphelfer Desktop/Secours (Public) und geplante private Dienste
...
| Retourup-Integrität | Verify Basic/Deep im Produkt | [ ] im Core |
...
| Maßnahme | Beschreibung | Status |
|----------|--------------|--------|
| Runtime-Watchdog | Retourend-Recovery (Dokumentation vorhanden) | [ ] gelb |
| Private-Server-HA | Telemetry/DiagNonstics (private) | [ ] nicht produktiv |
