> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/MODULE_CATALOG_EN.md`). Bitte bei Release manuell gegenlesen.

# Module Catalog (Source of Truth)

**As of:** post H.7 (final statusViewModel slice, `count_10`) · **No big-bang** — inventory and ownership.

Before new implementation, check this catalog, the [Function Ownership Matrix](FUNCTION_OWNERSHIP_MATRIX_EN.md), and [Do-Not-Duplicate Regeln](DO_NOT_DUPLICATE_RULES_EN.md).
