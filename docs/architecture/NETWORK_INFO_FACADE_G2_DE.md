> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/NETWORK_INFO_FACADE_G2_EN.md`). Bitte bei Release manuell gegenlesen.

# Network Info Fassade — Phase G.2 (EN)

**HEAD:** post G.3 · **Stand:** CANONICAL_MODULE (FACADE) — all app.py handlers migrated
