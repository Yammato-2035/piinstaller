> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DO_NOT_DUPLICATE_RULES_EN.md`). Bitte bei Release manuell gegenlesen.

# Do-Not-Duplicate Regeln (EN)
...
20. No network diagnostics in System Stand Fassade — use `network_info_facade` only (G.2+).
