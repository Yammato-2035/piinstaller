...
**As of:** post H.4 (`statusViewModel` second 3-component slice) · **No big-bang** — inventory and ownership.
...
**In progress:** **H.5** component migration. **H.4 done:** ReadyStableSection, StatusCard, RiskWarningCard (6 total with H.3).
