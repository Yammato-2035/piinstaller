...
**As of:** post G.2 (`network_info_facade`) · **No big-bang** — inventory and ownership.
...
**In progress:** **G.2b** Network router migration. **G.2 done:** `network_info_facade` contract. **G.1b done:** `/api/system/status` migrated.
