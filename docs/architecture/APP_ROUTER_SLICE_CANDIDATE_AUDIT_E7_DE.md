> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/APP_ROUTER_SLICE_CANDIDATE_AUDIT_E7_EN.md`). Bitte bei Release manuell gegenlesen.
...
- Backup/Restore/Deploy/Rettung/Partition write
...
**F.1** — DCC Stand Fassade (blocks status/roadmap-root).
