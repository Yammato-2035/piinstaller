> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/SYSTEM_INFO_FACADE_G6_EN.md`). Bitte bei Release manuell gegenlesen.

# System Info Fassade — G.6

**HEAD:** after G.6 · **Stand:** done
...
| Stand sections | `dcc_status_facade.build_section_status` |
