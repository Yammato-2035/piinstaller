> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_ROUTES_THIN_ORCHESTRATOR_TARGET_D6_EN.md`). Bitte bei Release manuell gegenlesen.

# Deploy Routes Thin Orchestrator — Ziel (Phase D.6)

**Stand:** target definition — **no refactoring in D.6**
