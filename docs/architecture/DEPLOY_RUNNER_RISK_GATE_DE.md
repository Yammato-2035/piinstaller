> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_RUNNER_RISK_GATE_EN.md`). Bitte bei Release manuell gegenlesen.
...
| `review_erforderlich` | Manual review |
| `blocked_operator_erforderlich` | Operator missing |
...
| `/api/deploy/runners/risk-gate/operator-erforderlich` | `list_runner_operator_erforderlich()` |
