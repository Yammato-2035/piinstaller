> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/architecture/DCC_STATUS_ROUTER_MIGRATION_F2_EN.md`). Bitte bei Release manuell gegenlesen.
...
See [DCC_AGGREGATION_AUDIT_F3_EN.md](DCC_AGGREGATION_AUDIT_F3_EN.md) · [DCC_Suivant_MIGRATIONS_F3_EN.md](DCC_Suivant_MIGRATIONS_F3_EN.md)
