> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/RESCUE_BROWSER_KIOSK_R4_EN.md`). Bitte bei Release manuell gegenlesen.

# Rettung Browser & Kiosk (R.4)

## Goal

Minimal display and browser stack in the live image for React Rettung UI kiosk mode.
