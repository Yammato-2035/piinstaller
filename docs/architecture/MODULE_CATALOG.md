...
**Stand:** nach E.5 (`app.py` Router-Slices) · **Kein Big-Bang** — Inventar und Ownership.
...
| `api/routes/dev_dashboard_roadmap.py` | **CANONICAL_ROUTER** (E.5) | roadmap areas/milestones/blockers/decisions/next-prompt |
| `app.py` Router-Slices | **IN_PROGRESS** | E.6+ (189 Routen verbleibend) |
