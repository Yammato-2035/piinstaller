...
**Stand:** nach H.5 (`statusViewModel` Utility-Slice) · **Kein Big-Bang** — Inventar und Ownership.
...
| **Komponenten/Utils (H.3–H.5)** | H.3–H.4: 6 Komponenten · H.5: governanceMatrix, roadmapFilter, buildGovernancePrompt |
...
| `frontend_status_viewmodel` | **CANONICAL_MODULE** (H.1–H.5) | count_20 verbleibend; H.6 |
