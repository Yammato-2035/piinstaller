> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/FRONTEND_STATUS_VIEWMODEL_MIGRATION_H2_EN.md`). Bitte bei Release manuell gegenlesen.

# Frontend Stand ViewModel Migration — H.2 (EN)

**HEAD:** post H.2 · **Stand:** utility migration done
...
| `lib/devDashboard/dccCompactStand.ts` | `deployDriftTone` | `dashboardToneFromInput` |
