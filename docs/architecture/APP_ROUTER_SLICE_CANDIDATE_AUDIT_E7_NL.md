> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/architecture/APP_ROUTER_SLICE_CANDIDATE_AUDIT_E7_EN.md`). Bitte bei Release manuell gegenlesen.
...
**E.8** — **done** (3 DCC alleen-lezen GET → `dev_dashboard_readonly.py`).  
