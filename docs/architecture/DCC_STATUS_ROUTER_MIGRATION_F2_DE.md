> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DCC_STATUS_ROUTER_MIGRATION_F2_EN.md`). Bitte bei Release manuell gegenlesen.

# DCC Stand Router Migration — Phase F.2 (EN)

**HEAD:** `8bb910c` · **Stand:** done
...
See [DCC_AGGREGATION_AUDIT_F3_EN.md](DCC_AGGREGATION_AUDIT_F3_EN.md) · [DCC_NEXT_MIGRATIONS_F3_EN.md](DCC_NEXT_MIGRATIONS_F3_EN.md)
