> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/WEBSERVER_STATUS_FACADE_G7_EN.md`). Bitte bei Release manuell gegenlesen.

# Webserver Stand Fassade — G.7 (EN)

**HEAD:** after G.7 · **Stand:** done
...
**G.6** System Info Fassade **or** **G.8** Network Discovery.
