> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_RUNNER_API_FACADE_EN.md`). Bitte bei Release manuell gegenlesen.

# Deploy Runner API Fassade (Phase C.3)

**Module:** `backend/deploy/runner_api_facade.py`  
**Fassade version:** `FACADE_VERSION = 4`
