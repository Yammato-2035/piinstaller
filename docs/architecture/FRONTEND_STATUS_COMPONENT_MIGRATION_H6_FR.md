> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/architecture/FRONTEND_STATUS_COMPONENT_MIGRATION_H6_EN.md`). Bitte bei Release manuell gegenlesen.
...
| `TrafficLightBadge.tsx` | `isjauneTrafficLightLamp` |
