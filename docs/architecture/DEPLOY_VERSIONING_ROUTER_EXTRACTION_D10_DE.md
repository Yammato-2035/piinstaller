> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_VERSIONING_ROUTER_EXTRACTION_D10_EN.md`). Bitte bei Release manuell gegenlesen.

# Deploy Versioning Router Extraktion (D.10)
