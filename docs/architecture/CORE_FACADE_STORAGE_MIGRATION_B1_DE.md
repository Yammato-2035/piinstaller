> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/CORE_FACADE_STORAGE_MIGRATION_B1_EN.md`). Bitte bei Release manuell gegenlesen.

# Core Fassade Storage Migration B.1
