> **Phase-1 Übersetzungsmarathon** — Français (automatisch aus `docs/architecture/FRONTEND_STATUS_COMPONENT_MIGRATION_H5_EN.md`). Bitte bei Release manuell gegenlesen.
...
| `buildGovernancePrompt.ts` | `isvertGovernanceTraffic`, `isrougeGovernanceTraffic`, `isjauneGovernanceTraffic` |
...
**H.6** presentation/domain slices or **G.4** Réseau handler extraction
