> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_EVIDENCE_ROUTER_EXTRACTION_D4_EN.md`). Bitte bei Release manuell gegenlesen.

# Deploy Evidence Router Extraktion (Phase D.4)
