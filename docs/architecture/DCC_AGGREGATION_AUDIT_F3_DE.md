> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DCC_AGGREGATION_AUDIT_F3_EN.md`). Bitte bei Release manuell gegenlesen.
...
| Stand duplicates | Cockpit, Überblick, Frontend — consolidate via ViewModel/Fassade F.4+ |
