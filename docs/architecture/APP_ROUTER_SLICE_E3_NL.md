> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/architecture/APP_ROUTER_SLICE_E3_EN.md`). Bitte bei Release manuell gegenlesen.
...
**E.4** — more file-based alleen-lezen GET routes.
