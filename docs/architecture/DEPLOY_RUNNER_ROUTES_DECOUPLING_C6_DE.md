> **Phase-1 Übersetzungsmarathon** — Deutsch (automatisch aus `docs/architecture/DEPLOY_RUNNER_ROUTES_DECOUPLING_C6_EN.md`). Bitte bei Release manuell gegenlesen.
...
Rettung/USB/ISO execute, sudo, destructive, failure-execution-preview.
