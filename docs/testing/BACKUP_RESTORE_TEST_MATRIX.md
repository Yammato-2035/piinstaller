...
|----|------|---------------|-----------|--------|----------|
| BR-001 | Full Backup freigegebenes Ziel | Nur **`/media/gabriel/setuphelfer-back`**; Runner-**`ReadWritePaths`**; kein paralleles **`apt`/`dpkg`** (UPDATE-CONFLICT-041); Backend stale-sync optional | Archiv + Manifest + SHA256 | Rot (**fehlgeschlagen** Job **`e341a326ac69`** — **`backup.blocked_package_activity`**; Runbook **`BR-001_package_activity_retry_runbook_2026-05-13.md`**) | `BR-001_package_activity_failure_2026-05-13.md`, `BR-001.json` |
...
**STRICT-Kette (2026-05-13):** Zusätzlich zu Runner/EROFS/stale-sync: Job **`e341a326ac69`** — Abbruch **`backup.blocked_package_activity`** (**`UPDATE-CONFLICT-041`**) bei **`apt-get autoremove --purge -y`** / **`mintupdate-automation-autoremove.timer`** — Evidence **`BR-001_package_activity_failure_2026-05-13.md`**, Runbook **`BR-001_package_activity_retry_runbook_2026-05-13.md`**. Früher: Job **`96ed5d89c443`** EROFS … **`BR-001_runner_systemd_readwritepaths_fix_2026-05-13.md`**. **STRICT-Retry:** Deploy **`/opt`** … **`BR-001_stale_job_sync_fix_and_retry_2026-05-13.md`**. Starter-Allowlist, **`BR-001_full_backup_run_2026-05-13.md`**.
