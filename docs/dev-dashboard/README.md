...
- **Ports & Profile (zentral):** [PORTS_AND_PROFILES.md](./PORTS_AND_PROFILES.md), `config/runtime_ports.json`, live in `/api/version` (Ingest: `../evidence/dev-dashboard/RUNTIME_PORTS_REGISTRY_DEPLOY_INGEST_RESULT.md`, QEMU-Readiness `runtime_ports_registry_qemu_readiness_latest.json`)
