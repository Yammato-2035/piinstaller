...
**STRICT Backup/Verify-Kette:** BR-004 und BR-005 gelten nur dann als abgenommen, wenn sie **dasselbe Archiv** prüfen, das BR-001 auf einem **freigegebenen** externen Ziel erzeugt hat (siehe `docs/testing/BACKUP_RESTORE_TEST_MATRIX.md`, `docs/evidence/release-gates/backup_restore_release_gate.json`). **Hinweis 2026-05-12:** **Device-/Mount-Baseline** (`BR-001_device_mount_baseline_2026-05-12.{md,json}`): BR-Pfad liegt auf internem Root-FS; externes `setuphelfer-back` auf **`/dev/sda1`** — **blocked** bis Bind+Freigabe. Zuvor: `BR-001_productive_target_check_2026-05-12.md`, `BR-001.json`, `BR-001_mnt_setuphelfer_target_prepare_2026-05-12.md`.
