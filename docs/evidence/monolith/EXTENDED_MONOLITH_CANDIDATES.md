...
**Datum:** 2026-06-10  
**HEAD:** nach H.4 · **Update:** 6 Komponenten migriert; count_23 verbleibend.
...
1. **E.1** app.py Router-Slice — **erledigt** (4 GET)
...
6. **E.6** app.py Router-Slice — **erledigt** (2 roadmap next-prompt GET)
7. **E.7** app.py Router-Slice — nächster Schritt
