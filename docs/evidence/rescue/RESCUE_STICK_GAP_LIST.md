...
| Boot | Live-Medium-Stabilität FAT32-ESP | partial (Fix in Repack, Stick pending) | `RS_001_LIVE_MEDIUM_RETEST_HANDOFF.md` | Payload-Update nicht in Agent-Umgebung | P0 | `update-fat32-esp-live-payload.sh` + Retest |
