...
|---------|---------------|------------|-------|--------|-----------|------------------|
| Boot | RS-001 Stick Acceptance | ok (L1–4) | `RS_001_STICK_ACCEPTANCE_RESULT.md` | HW Level 6 pending | P0 | Operator Boot MSI |
| Boot | x86_64 UEFI HW-Boot Level 6 | pending (1.7.11.0) | `RS_001_REACT_RESCUE_HARDWARE_RETEST_RESULT.md` | Agent kann keinen phys. Boot | P0 | Operator Phase 1 |
