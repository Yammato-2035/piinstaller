...
| P08 | Payload/Stick | 1.10.2.9 physisch | Build=Stick | Stick Ultra Line | ESP squashfs | Bump 1.10.3.1 + inject | controlled | erlaubt | none | teil | SHA256 gate | manifest | — | payload tag | vorherige squashfs backup | SHA mismatch | nein | ja | Packaging | SHA match | P09 |
