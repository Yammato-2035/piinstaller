...
**Nach Push des sudoers-Boundary-Fixes (3520621):** Run **25750787235** — weiterhin **failure** am Harness (`/mnt`); der Test `test_no_sudoers_file_written` lief in diesem Lauf **vor** dem ersten `-x` erfolgreich.

**Nach Harness-Portabilität (55d7cec):** Run **25751304968** — **`conclusion: success`** für den gesamten `ci.yml`-Workflow (siehe `ci_deploy_write_harness_mnt_setuphelfer_analysis_2026-05-11.md`).
