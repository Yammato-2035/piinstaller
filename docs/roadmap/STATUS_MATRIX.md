...
| **Live Boot (Developer ISO)** | Gelb | QEMU host-ingest `qemu_rescue_developer_host_ingest_20260531_120711`: Boot+Login OK; **kein** Dev-Server-Report; Gast-Server failed; Keyboard EN; `network_bind_pending` (Host `127.0.0.1:8000`) | `RESCUE_DEVELOPER_ISO_QEMU_HOST_INGEST_RESULT.md`, `RESCUE_DEVELOPER_ISO_QEMU_BOOT_SMOKE_RESULT.md` |
