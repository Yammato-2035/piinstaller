...
| **Backup Execute Router** | **Gelb** | **B.4–B.6** — 13 POST (jobs/profiles/settings/cloud/usb/target-prepare) | `BACKUP_EXECUTE_ROUTER_B6.md` |
| **App Router Slices (System)** | **Gelb** | **E.10–E.11** — 11 system routes extrahiert | `APP_ROUTER_SLICE_E11.md` |
...
| **Legal/Beta Readiness** | **Gelb** | Checklisten public-safe, keine Rechtsberatung | `docs/legal/BETA_TEST_READINESS_CHECKLIST_DE.md` |
| **Private Repo Setup** | **Rot/Pending** | Runbook only, kein Repo angelegt | `docs/runbooks/PRIVATE_REPOSITORY_SETUP_RUNBOOK_DE.md` |
