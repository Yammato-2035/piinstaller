...
| **Developer QEMU ISO Rebuild** | Rot | Post-fix rebuild **blocked** (Agent sudo); ISO `3ee02b36…` ohne Autopilot wants | `DEVELOPER_QEMU_ISO_REBUILD_AFTER_AUTOPILOT_RESULT.md` |
