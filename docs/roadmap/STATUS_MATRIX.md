...
| **QEMU Guest Agent Smoke** | Rot | Agent blocked (`sudo`/local_lab); Operator-Skript bereit; kein QEMU in Agent-Lauf | `QEMU_GUEST_AGENT_SMOKE_RESULT.md`, `qemu_guest_agent_smoke_latest.json` |
