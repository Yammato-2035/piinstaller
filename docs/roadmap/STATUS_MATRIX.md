...
**Stand:** 2026-05-12 — **CI:** Run **25751304968** success. **BR-001:** Freigabepfad; API STORAGE-001 — Ursache Shell vs. API dokumentiert — **blocked**. **Release** rot.  
...
| Backup | Rot | BR-001 blocked — STORAGE-001 auf `/media/gabriel/setuphelfer-back`; Analyse C+D | `BR-001.json`, `BR-001_productive_target_check_media_path_analysis_2026-05-12.md` |
