...
| **Developer QEMU ISO Rebuild** | Gelb | LB_EXIT=0, profile=developer-qemu verified; ISO SHA `3ee02b36…`; autopilot wants gap — review before smoke | `DEVELOPER_QEMU_ISO_REBUILD_RESULT.md`, `developer_qemu_iso_rebuild_verify_latest.json` |
