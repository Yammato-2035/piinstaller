...
**Stand:** 2026-05-12 — **CI:** Run **25751304968** success. **BR-001:** Freigabepfad; historisch API STORAGE-001 — **Workspace-Diagnosefix STORAGE-006** dokumentiert — **blocked** (E2E-/produktiver grüner Check ausstehend). **Release** rot.  
...
| Backup | Rot | BR-001 blocked — E2E/produktiver Check ausstehend; Diagnosefix 006 im Workspace (`BR-001_target_permission_diagnostics_fix_2026-05-12.md`) | `BR-001.json`, `BR-001_productive_target_check_media_path_analysis_2026-05-12.md` |
