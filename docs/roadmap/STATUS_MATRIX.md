...
| **Rescue stick read-only build emulation** | Gelb | Post-Deploy Abnahme 2026-05-24: API+run-all grün (Emulation); Final-Gate **review_required** (Paketliste/Live-OS-Netz; Runtime-dist CDN bis Redeploy); systemd/LAN entschieden; kein ISO | `docs/evidence/rescue/RESCUE_STICK_READONLY_BUILD_EMULATION.md`, `docs/architecture/RESCUE_STICK_READONLY_BUILD_GATE.md` |
