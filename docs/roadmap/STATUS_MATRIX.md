...
| Rescue Stick | Gelb | RS-P2C: Failsafe GRUB + Textmodus-Default + GUI-Watchdog auf 1.9.5.2 — MSI-Retest RS-P2D | `RS_P2C_FINAL_RESULT.md`, `RS_P2C_CAPABILITY_MARKER.json` |
