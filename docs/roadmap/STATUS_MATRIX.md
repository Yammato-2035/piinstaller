...
| **QEMU Guest Agent Smoke** | Gelb | ISO developer-qemu + Autopilot wants verifiziert; Preflight-Guard gehärtet; **Operator-Smoke ausstehend** (Runtime `release`; prior failures bei deaktiviertem Devserver kein Agent-Defekt) | `DEVELOPER_QEMU_ISO_AFTER_AUTOPILOT_SUCCESS_INGEST_RESULT.md`, `QEMU_GUEST_AGENT_DEVSERVER_PREFLIGHT_GUARD_RESULT.md` |
