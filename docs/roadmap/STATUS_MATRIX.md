...
| **Backup Execute Router** | **Gelb** | **B.4–B.5** — 9 POST (jobs/profiles/settings/cloud) | `BACKUP_EXECUTE_ROUTER_B5.md` |
| **App Router Slices (System)** | **Gelb** | **E.10** — 5 system routes extrahiert | `APP_ROUTER_SLICE_E10.md` |
