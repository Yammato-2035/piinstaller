...
| **Live Boot (Developer ISO)** | Gelb | Host-reachability + module-path fix (`894b726`→); Lab-Proxy `8001`; ISO-Rebuild blocked; Ingest pending | `RESCUE_QEMU_HOST_REACHABILITY_AND_AGENT_MODULE_PATH_FIX.md` |
