...
| **Developer QEMU ISO Rebuild** | Gelb | LB_EXIT=0 ISO `3ee02b36…` ohne autopilot wants; **Fix committed** — Rebuild ausstehend | `DEVELOPER_QEMU_ISO_REBUILD_RESULT.md`, `DEVELOPER_QEMU_AUTOPILOT_ENABLE_FIX_RESULT.md` |
