...
| **Controlled ISO build (2026-06-02)** | Gelb | LB_EXIT=0; ISO `505989f7…`; Squashfs-Validator 0; **kein Boot/USB** — ready for QEMU guest-agent smoke | `CONTROLLED_RESCUE_ISO_BUILD_RESULT.md`, `controlled_iso_build_artifact_verify_latest.json` |
