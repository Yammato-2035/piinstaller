...
| **Developer QEMU ISO Rebuild** | Gelb | LB_EXIT=34 Preflight (root-owned); Profil-Mismatch standard; Clean+Build Operator ausstehend | `DEVELOPER_QEMU_REBUILD_BLOCKER_RESULT.md`, `developer_qemu_rebuild_readiness_latest.json` |
