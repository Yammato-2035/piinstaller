...
| **QEMU Guest Agent Smoke** | Rot | Run `20260603_111427`: boot+autopilot ok; **devserver_agent import + Host header** fix in workspace; ISO rebuild + validator 0 before re-smoke | `DEVSERVER_AGENT_ISO_REPORT_FIX_RESULT.md` |
