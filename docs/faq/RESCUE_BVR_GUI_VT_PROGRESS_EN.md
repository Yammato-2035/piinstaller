...
13. **What was the 1.10.1.2 retest (002R) result?** BVR on MSI GE63 passed (`…-05b6f187`); HTTP ready and VT7 prepared; operator saw **no** GUI → status `passed_with_gui_fallback`, not `passed`.
