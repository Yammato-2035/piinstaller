...
**Device:** MSI-Rechner (Hardware-E2E-Strang)  
...
2. Als Windows-System gesichert werden (externales Ziel)
...
9. Mit Malware-Kompass (externale Tools) geprüft werden
...
- **Kein** Schreiben auf internale MSI-Storage device vor Freigabe
- **Kein** Restore auf falsches Ziel
- **Kein** dd/mkfs/parted/wipefs ohne separate Operator-Freigabe
- Backup-Ziel muss **external** sein
- internale Systemplatte darf **nicht** als Backup-Ziel dienen
...
- Zielmedium sicher klassifiziert (external, ausreichend frei)
...
- Keine internale Platte versehentlich überschrieben
