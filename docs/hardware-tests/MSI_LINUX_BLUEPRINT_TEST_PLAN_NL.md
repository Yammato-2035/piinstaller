> **Phase-1 Übersetzungsmarathon** — Nederlands (automatisch aus `docs/hardware-tests/MSI_LINUX_BLUEPRINT_TEST_PLAN_EN.md`). Bitte bei Release manuell gegenlesen.
...
**Nach:** Windows Terugup + Verify + Herstel-Evidence + Wipe-Freigabe  
...
6. Linux Terugup → Verify → Herstel auf Externem Ziel testen
...
| Terugup Extern | BR-001-konform |
| Verify OK | Manifest + SHA256 |
| Herstel-Test OK | separater Testdisk |
