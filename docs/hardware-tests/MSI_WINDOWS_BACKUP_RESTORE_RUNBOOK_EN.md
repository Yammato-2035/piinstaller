> **Phase-1 Übersetzungsmarathon** — English (automatisch aus `docs/hardware-tests/MSI_WINDOWS_BACKUP_RESTORE_RUNBOOK_DE.md`). Bitte bei Release manuell gegenlesen.
...
- [ ] externales Backup-Ziel bestätigt (`externalal_confirmed: true`)
...
- Ziel: nur externales Medium
- Kein Schreiben auf `/dev/nvme*` / internale MSI-Disk
...
- Ziel: **freigegebenes Testmedium** (nicht MSI-internal)
