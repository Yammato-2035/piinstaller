                    ...
                    <div className="p-4 text-sm">
                      ...
                      <div className="rounded bg-emerald-950/30 border border-emerald-700/40 p-3 mt-2">
                        ...
                        <ul className="list-disc list-inside text-slate-300 space-y-1">
                          ...
                          <li>Mit Auswahl Tauri / Browser / Nur Backend: <code className="bg-slate-700 px-1 rounded">./scripts/start-setuphelfer.sh</code> bzw. <strong>SetupHelfer.desktop</strong> auf dem Schreibtisch</li>
