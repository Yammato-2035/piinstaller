...
#       14 dangerous cmd | 15 ssh | 16 write | 20 unknown
...
import json
from devserver_agent.rescue_profile import validate_developer_profile, validate_public_profile_guard
...
print(json.dumps({'developer': dev, 'public': pub}))
")"
