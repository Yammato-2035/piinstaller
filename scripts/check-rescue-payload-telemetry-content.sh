...
squashfs = Path(
    __import__("os").environ.get("SETUPHELFER_RESCUE_PAYLOAD_SQUASHFS", "")
) if __import__("os").environ.get("SETUPHELFER_RESCUE_PAYLOAD_SQUASHFS") else default_repacked_squashfs_path()
