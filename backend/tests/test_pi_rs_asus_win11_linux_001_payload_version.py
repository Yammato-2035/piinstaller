"""Payload version gate for PI-RS-ASUS-WIN11-LINUX-001."""
...
class PayloadVersionTests(unittest.TestCase):
    def test_payload_version(self) -> None:
        ...
        self.assertEqual(data["rescue_payload_version"], "1.10.1.3")
    ...
    def test_app_version(self) -> None:
        ...
        self.assertEqual(data["project_version"], "1.9.21.0")
