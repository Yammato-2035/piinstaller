...
class PayloadTelemetry001VersionTests(unittest.TestCase):
    def test_rescue_payload_version_is_1_10_0_14(self) -> None:
        self.assertEqual(rescue_payload_version(), "1.10.0.14")

    def test_previous_version_documented(self) -> None:
        self.assertEqual(previous_rescue_payload_version(), "1.10.0.13")
    ...
    def test_config_file_present(self) -> None:
        ...
        self.assertEqual(data["rescue_payload_version"], "1.10.0.14")
    ...
    def test_load_config_cached(self) -> None:
        ...
        self.assertEqual(cfg["rescue_payload_version"], "1.10.0.14")
