...
class GabrielGrubTests(unittest.TestCase):
    def test_default_is_install_gui_not_msi_e2e(self) -> None:
        ...
        self.assertIn("setuphelfer_g513qm_profile=g513qm_basic_emergency", cfg)
        ...
        self.assertIn(grub.MINT_CASPER_HYBRID_TITLE, cfg)
        self.assertNotIn("quiet splash", cfg)
        self.assertIn("set gfxpayload=text", cfg)
