"""PI-RS-E2E-LIVE-001D6 payload version tests (1.10.0.24 — TUI refresh + heartbeat failsafe)."""
...
class E2ELive001D6PayloadVersionTests(unittest.TestCase):
    def test_rescue_payload_version_is_1_10_0_24(self) -> None:
        self.assertEqual(rescue_payload_version(), "1.10.0.24")

    def test_previous_version_documented(self) -> None:
        self.assertEqual(previous_rescue_payload_version(), "1.10.0.23")
    ...
    def test_config_file_present(self) -> None:
        ...
        self.assertEqual(data["rescue_payload_version"], "1.10.0.24")
    ...
    def test_load_config_cached(self) -> None:
        ...
        self.assertEqual(cfg["rescue_payload_version"], "1.10.0.24")
    ...
    def test_e2e_content_artifact_when_present(self) -> None:
        artifact = (
            ...
            / "build"
            / "rescue"
            / "filesystem.squashfs.repacked-1.10.0.24"
        )
