...
plan_mod = _load("recovery/activation_plan.py", "setuphelfer_recovery_activation_plan_test")
routes_mod = _load("recovery/routes.py", "setuphelfer_recovery_routes_activation_test")
